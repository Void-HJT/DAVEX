...
export const getGroupByApplicationId = (
  ...
  let res = request.post('/directory/group/getGroupByApplicationId', params.toString())
  return res
}
...
export const addApplicationGroup = (
  ...
  params.append('applicationId', applicationId);
  params.append('groupId', groupId);
  let res = request.post('/directory/group/addApplicationGroup', params.toString())
  return res
}
...
export const deleteApplicationGroup = (
  ...
  params.append('applicationId', applicationId);
  params.append('groupId', groupId);
  let res = request.post('/directory/group/deleteApplicationGroup', params.toString())
  return res
}