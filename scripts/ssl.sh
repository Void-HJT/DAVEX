...
rm DVE_${module}/src/main/resources/jwt.jks
rm DVE_${module}/src/main/resources/truststore.jks
...
rm jwt.cer
mv jwt.jks DVE_${module}/src/main/resources
mv truststore.jks DVE_${module}/src/main/resources
