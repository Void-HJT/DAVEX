...
//            copyFile(filePath, fileName, downloadPath.toString());
            ...
            // common 中同一路径只有一个实际文件，只保留当前所有者记录。
    ...
    public Body<String> deleteFile(String applicationId, Long outputId) {
        ...
        try {
            ...
            // 删除历史结果时不能误删后来覆盖到同一路径的 common 副本。
            if (ownsCommonFile) {
