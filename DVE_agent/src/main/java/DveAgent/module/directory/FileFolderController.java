...
public class FileFolderController {
    ...
    public Body<String> setFolderName(@RequestParam("agentId") Long agentId,
        ...
        return fileFolderService.setFolderName(agentId,folderId,name,BASE_DIRECTORY);
    }

    @PostMapping("/deleteFolder")
    public Body<String> deleteFolder(@RequestParam("agentId") Long agentId,
                                     @RequestParam("folderId") Long folderId){
        return fileFolderService.deleteFolder(agentId,folderId,BASE_DIRECTORY);
    }

    @PostMapping("/getFolderPath")
    public Body<String> getFolderPath(@RequestParam("agentId") Long agentId,
                                      @RequestParam("folderId") Long folderId){
        return fileFolderService.getFolderPath(agentId,folderId,BASE_DIRECTORY);
    }
    ...
    public  Body<String> uploadFile(@RequestParam("agentId") Long agentId,
        ...
        return fileFolderService.uploadFile(agentId,folderId,file,BASE_DIRECTORY);
    }
    ...
    public Body<String> deleteFile(@RequestParam("fileId") Long fileId,
                                   @RequestParam("agentId") Long agentId,
                                   @RequestParam("folderId") Long folderId){
        return fileFolderService.deleteFile(fileId,agentId,folderId,BASE_DIRECTORY);
    }
    ...
    public ResponseEntity<Resource> sendFile(@RequestParam("fileId") Long fileId,
        ...
        return fileFolderService.sendFile(fileId,agentId,folderId,BASE_DIRECTORY);
    }
