...
/** 验证 Center MPC 程序包适配器保持查询、下载端点及返回数据。 */
@ExtendWith(MockitoExtension.class)
class WebClientCenterMpcArtifactClientTest {
    ...
    private WebClientCenterMpcArtifactClient client;

    @BeforeEach
    @SuppressWarnings({"rawtypes", "unchecked"})
    void setUp() throws Exception {
        client = new WebClientCenterMpcArtifactClient(webClientService);
    ...
    void fetchesMetadataAndProgramUsingStableEndpoints() throws Exception {
        ...
        CenterMpcArtifactClient.Artifact artifact =
                client.fetchArtifact("CENTER-1", "MPC-1");
