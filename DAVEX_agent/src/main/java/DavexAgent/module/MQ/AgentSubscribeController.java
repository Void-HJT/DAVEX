...
public class AgentSubscribeController {
    ...
    public Body<String> subscribe(@RequestParam("centerId") String centerId,
        ...
        return agentSubscribeService.subscribeToCenter(centerId, queueName, routingKey, new AgentMessageListener());
    }

    @PostMapping("/unsubscribe")
    public Body<String> unsubscribe(@RequestParam("queueName") String queueName){
        return agentSubscribeService.unsubscribe(queueName);
    }
}
